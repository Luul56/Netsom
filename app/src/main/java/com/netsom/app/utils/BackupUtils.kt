...
import com.netsom.app.plugins.PLUGINS_KEY
import com.netsom.app.plugins.PLUGINS_KEY_LOCAL
import com.netsom.app.syncproviders.AccountManager
import com.netsom.app.syncproviders.providers.AniListApi.Companion.ANILIST_CACHED_LIST
import com.netsom.app.syncproviders.providers.MALApi.Companion.MAL_CACHED_LIST
import com.netsom.app.syncproviders.providers.KitsuApi.Companion.KITSU_CACHED_LIST
import com.netsom.app.utils.Coroutines.ioSafe
import com.netsom.app.utils.Coroutines.main
import com.netsom.app.utils.DataStore.getDefaultSharedPrefs
import com.netsom.app.utils.DataStore.getSharedPrefs
import com.netsom.app.utils.DataStore.mapper
import com.netsom.app.utils.UIHelper.checkWrite
import com.netsom.app.utils.UIHelper.requestRW
import com.netsom.app.utils.downloader.VideoDownloadManager.setupStream
import com.netsom.app.utils.downloader.DownloadObjects
import com.netsom.app.utils.downloader.DownloadQueueManager.QUEUE_KEY
import com.netsom.app.utils.downloader.VideoDownloadManager.KEY_DOWNLOAD_INFO
import com.netsom.app.utils.downloader.VideoDownloadManager.KEY_RESUME_IN_QUEUE
import com.netsom.app.utils.downloader.VideoDownloadManager.KEY_RESUME_PACKAGES
...
object BackupUtils {
    ...
    /**
     * Copy of [com.netsom.app.utils.downloader.VideoDownloadManager.basePathToFile], [com.netsom.app.utils.downloader.VideoDownloadManager.getDefaultDir] and [com.netsom.app.utils.downloader.VideoDownloadManager.getBasePath]
