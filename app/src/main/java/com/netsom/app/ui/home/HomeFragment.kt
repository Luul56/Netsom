...
import com.netsom.app.AllLanguagesName
import com.netsom.app.CommonActivity.showToast
import com.netsom.app.MainAPI
import com.netsom.app.R
import com.netsom.app.SearchResponse
import com.netsom.app.TvType
import com.netsom.app.databinding.FragmentHomeBinding
import com.netsom.app.databinding.HomeEpisodesExpandedBinding
import com.netsom.app.databinding.HomeSelectMainpageBinding
import com.netsom.app.databinding.TvtypesChipsBinding
...
import com.netsom.app.ui.APIRepository.Companion.noneApi
import com.netsom.app.ui.APIRepository.Companion.randomApi
import com.netsom.app.ui.BaseFragment
import com.netsom.app.ui.account.AccountHelper.showAccountSelectLinear
import com.netsom.app.ui.account.AccountViewModel
import com.netsom.app.ui.search.SEARCH_ACTION_LOAD
import com.netsom.app.ui.search.SEARCH_ACTION_PLAY_FILE
import com.netsom.app.ui.search.SearchAdapter
import com.netsom.app.ui.search.SearchHelper.handleSearchClickCallback
...
import com.netsom.app.utils.AppContextUtils.filterProviderByPreferredMedia
import com.netsom.app.utils.AppContextUtils.getApiProviderLangSettings
import com.netsom.app.utils.AppContextUtils.isNetworkAvailable
import com.netsom.app.utils.AppContextUtils.isRecyclerScrollable
import com.netsom.app.utils.AppContextUtils.loadSearchResult
import com.netsom.app.utils.AppContextUtils.ownHide
import com.netsom.app.utils.AppContextUtils.ownShow
import com.netsom.app.utils.AppContextUtils.setDefaultFocus
import com.netsom.app.utils.BackPressedCallbackHelper
...
import com.netsom.app.utils.EmptyEvent
import com.netsom.app.utils.SubtitleHelper.getFlagFromIso
...
import com.netsom.app.utils.UIHelper.getSpanCount
