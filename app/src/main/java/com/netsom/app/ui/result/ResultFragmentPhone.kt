...
import com.netsom.app.APIHolder
import com.netsom.app.CommonActivity.showToast
import com.netsom.app.DubStatus
import com.netsom.app.LoadResponse
import com.netsom.app.MainActivity.Companion.afterPluginsLoadedEvent
import com.netsom.app.R
import com.netsom.app.Score
import com.netsom.app.SearchResponse
import com.netsom.app.base64Encode
import com.netsom.app.databinding.FragmentResultBinding
import com.netsom.app.databinding.FragmentResultSwipeBinding
import com.netsom.app.databinding.ResultRecommendationsBinding
import com.netsom.app.databinding.ResultSyncBinding
...
import com.netsom.app.ui.download.DOWNLOAD_ACTION_DOWNLOAD
import com.netsom.app.ui.download.DOWNLOAD_ACTION_LONG_CLICK
import com.netsom.app.ui.download.DownloadButtonSetup
import com.netsom.app.ui.player.CSPlayerEvent
import com.netsom.app.ui.player.FullScreenPlayer
import com.netsom.app.ui.player.source_priority.QualityProfileDialog
import com.netsom.app.ui.quicksearch.QuickSearchFragment
import com.netsom.app.ui.result.ResultFragment.bindLogo
import com.netsom.app.ui.result.ResultFragment.getStoredData
import com.netsom.app.ui.result.ResultFragment.updateUIEvent
import com.netsom.app.ui.search.SearchAdapter
import com.netsom.app.ui.search.SearchHelper
...
import com.netsom.app.utils.AppContextUtils.openBrowser
...
import com.netsom.app.utils.BatteryOptimizationChecker.openBatteryOptimizationSettings
...
import com.netsom.app.utils.SingleSelectionHelper.showBottomDialogInstant
...
import com.netsom.app.utils.UIHelper.populateChips
import com.netsom.app.utils.UIHelper.popupMenuNoIconsAndNoStringRes
import com.netsom.app.utils.UIHelper.setListViewHeightBasedOnItems
            ...
            resultSubscribe.setOnClickListener {
                viewModel.toggleSubscriptionStatus(context) { newStatus: Boolean? ->
                    ...
                    val name = (viewModel.page.value as? Resource.Success)?.value?.title
                        ?: com.netsom.app.utils.txt(R.string.no_data)
                            .asStringNull(context) ?: ""
                    showToast(
                        com.netsom.app.utils.txt(message, name),
                        Toast.LENGTH_SHORT
                    )
                }
        ...
        observe(viewModel.page) { data ->
            ...
            resultBinding?.apply {
                ...
                resultTitle.setOnLongClickListener {
                    clipboardHelper(
                        com.netsom.app.utils.txt(R.string.title),
                        resultTitle.text
                    )
                    true
                }
