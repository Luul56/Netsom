...
import com.netsom.app.databinding.FragmentPluginDetailsBinding
import com.netsom.app.plugins.PluginManager
import com.netsom.app.plugins.VotingApi.canVote
import com.netsom.app.plugins.VotingApi.getVotes
import com.netsom.app.plugins.VotingApi.hasVoted
import com.netsom.app.plugins.VotingApi.vote
import com.netsom.app.R
import com.netsom.app.ui.BaseBottomSheetDialogFragment
    ...
    override fun onBindingCreated(binding: FragmentPluginDetailsBinding) {
        ...
        binding.apply {
            ...
            if (data.isDownloaded) {
                ...
                val plugin =
                    (PluginManager.urlPlugins[metadata.url] ?: PluginManager.plugins[metadata.url]) as? com.netsom.app.plugins.Plugin
