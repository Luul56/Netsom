...
import com.netsom.app.CloudStreamApp
...
import com.netsom.app.LoadResponse.Companion.getImdbId
import com.netsom.app.LoadResponse.Companion.getMalId
import com.netsom.app.LoadResponse.Companion.getTMDbId
import com.netsom.app.MainActivity
import com.netsom.app.R
import com.netsom.app.TvType
import com.netsom.app.amap
import com.netsom.app.databinding.DialogOnlineSubtitlesBinding
import com.netsom.app.databinding.FragmentPlayerBinding
import com.netsom.app.databinding.PlayerSelectSourceAndSubsBinding
import com.netsom.app.databinding.PlayerSelectTracksBinding
import com.netsom.app.isAnimeOp
import com.netsom.app.isEpisodeBased
import com.netsom.app.isLiveStream
import com.netsom.app.isMovieType
...
import com.netsom.app.subtitles.AbstractSubtitleEntities
import com.netsom.app.subtitles.AbstractSubtitleEntities.SubtitleSearch
import com.netsom.app.syncproviders.AccountManager.Companion.subtitleProviders
import com.netsom.app.ui.download.DownloadButtonSetup
import com.netsom.app.ui.player.CS3IPlayer.Companion.preferredAudioTrackLanguage
import com.netsom.app.ui.player.CustomDecoder.Companion.updateForcedEncoding
import com.netsom.app.ui.player.PlayerSubtitleHelper.Companion.toSubtitleMimeType
import com.netsom.app.ui.player.source_priority.LinkSource
...
import com.netsom.app.ui.player.source_priority.QualityProfileDialog
import com.netsom.app.ui.result.ACTION_CLICK_DEFAULT
import com.netsom.app.ui.result.EpisodeAdapter
import com.netsom.app.ui.result.FOCUS_SELF
import com.netsom.app.ui.result.ResultEpisode
import com.netsom.app.ui.result.ResultFragment
...
import com.netsom.app.ui.result.setLinearListLayout
import com.netsom.app.ui.setRecycledViewPool
...
import com.netsom.app.ui.subtitles.SUBTITLE_AUTO_SELECT_KEY
import com.netsom.app.ui.subtitles.SubtitlesFragment
import com.netsom.app.ui.subtitles.SubtitlesFragment.Companion.getAutoSelectLanguageTagIETF
import com.netsom.app.utils.AppContextUtils.getShortSeasonText
...
import com.netsom.app.utils.SingleSelectionHelper.showDialog
import com.netsom.app.utils.SubtitleHelper.fromTagToEnglishLanguageName
import com.netsom.app.utils.SubtitleHelper.fromTagToLanguageName
import com.netsom.app.utils.SubtitleHelper.languages
...
import com.netsom.app.utils.UIHelper.hideSystemUI
import com.netsom.app.utils.UIHelper.popCurrentPage
